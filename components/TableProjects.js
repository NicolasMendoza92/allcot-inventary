...
export const TableProjects = () => {
  ...
  useEffect(() => {
    setFilterList((prev) => {
      ...
      if (filtersMui.regulatedMarket)
        newFilterList[0] = filtersMui.regulatedMarket; // Ajustar el índice según la columna correcta
  ...
  const options = {
    ...
    responsive: "simple",
    searchOpen: false,
    download: !isUserRestricted, // Ocultar el botón de descarga
    viewColumns: !isUserRestricted, // Ocultar el botón para ver columnas
    print: !isUserRestricted, // Ocultar el botón de imprimir
  };
