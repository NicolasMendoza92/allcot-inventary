        ...
        <table className=" basic my-3">
          ...
          <tbody>
            ...
            {filteredReservations.map((r) => (
              <tr key={r._id}>
                <td>
                  {new Date(r.createdAt).toLocaleString("GB-English", {
                    dateStyle: "short",
                  })}
                </td>
                <td>{r.team}</td>
                ...
                <td>{r.customer}</td>
                <td>
                  {r.projectRelated?.standar} {r.projectRelated?.projectID}{" "}
                  {r.projectRelated?.name}
                </td>
                ...
                <td>{r.status}</td>
                <td>
                  {new Date(r.expiration).toLocaleString("GB-English", {
                    dateStyle: "short",
                  })}
                </td>
                <td>{r.comments}</td>
