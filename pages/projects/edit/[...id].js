        ...
        <>
          <div className="flex justify-between content-center">
            ...
            <div className='flex gap-2'>
              {session.user.email === 'demo@gmail.com'  || session.user.email === 'mdo@karbon-x.com' ? (<> <button className="bg-gray-300 text-white px-3 py-1 ms-1 mt-1 rounded shadow-sm hover:bg-gray-200" >
                <Link href={'/inventary'}>
